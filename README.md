...
* ***Instructions:***
  ...
  * you should see the Julia REPL. Type in the following commands
  ...
  <img src=pictures/JuliaREPL.png width="300" height="170" />
